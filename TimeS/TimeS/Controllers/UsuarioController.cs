...
namespace TimeS.Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(UsuarioManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public ActionResult DetalhesCompleto()
        {
            return View();
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            if(!usuarioBll.GetUsuarioPorEmail(model.Email).Ativo)
            {
                ModelState.AddModelError("", "Usuario Desativado.");
                return RedirectToLocal("/");
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase image)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new Usuario() { UserName = model.Email, Email = model.Email, Nome = model.Nome, Ativo = true };
                if (image != null)
                {

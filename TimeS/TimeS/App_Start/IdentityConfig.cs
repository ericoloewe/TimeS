...
namespace TimeS
{
    ...
    public class UsuarioManager : UserManager<Usuario>
    {
        ...
        {
            var manager = new UsuarioManager(new UserStore<Usuario>(context.Get<TimeS.DAL.TimeSContext>()));
    ...
    {
        public ApplicationSignInManager(UsuarioManager userManager, IAuthenticationManager authenticationManager)
        ...
        {
            return new ApplicationSignInManager(context.GetUserManager<UsuarioManager>(), context.Authentication);
        }
    }
}
